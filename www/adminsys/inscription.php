                ...
                if ($mdp === $mdp2) {
                        ...
                        if ($resultat === false) {
                            ...
                            if ($bddGenerique->exec($sql)) {
                                ...
                                array_push($erreur, '<span style="color: red">Un problème est survenu</span>');
                            }
                        } else {
                            array_push($erreur, '<span style="color: red">Ce nom de compte est déjà utilisé</span>');
                        }
                } else {
                    array_push($erreur, "<span style='color: red'>Vos mots de passe ne sont pas similaire<span>");
                }
            } else {
                array_push($erreur, "<span style='color: red'>Mot de passe incorrect</span>");
            }
        } else {
            array_push($erreur, "<span style='color: red'>Tout les champs n'ont pas été rempli</span>");
        }
    }
} catch (Exception $e) {
    ...
    <body>
        ...
        <div style="padding-top: 100px" class="container">
            <div class="row">
                <div class="col-12">
                    <br />
                    <h1 class="text-center">Inscription administrateur</h1><br />
                </div>
                <div class="col-sm-6 offset-sm-3" style="padding-bottom: 20px">
                    <form method="post" action="">
                        ...
                        <label style="padding-top: 20px" for="mdpadmin">Mot de passe administrateur</label>
                        <input type="password" name="mdpadmin" id="mdpdamin" class="form-control">
                        <br />
